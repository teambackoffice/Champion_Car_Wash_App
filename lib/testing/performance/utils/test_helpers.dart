...
class PerformanceTestHelpers {
  ...
  static String generatePerformanceReport(
    ...
    for (final result in results) {
      ...
      if (result.showsImprovement) {
        buffer.writeln(
          '    Improvement: +${result.improvementPercentage.toStringAsFixed(1)}%',
        );
      }
    ...
    if (metrics != null) {
      ...
      buffer.writeln(
        '  Memory Usage: ${metrics.memoryUsageMB.toStringAsFixed(1)} MB',
      );
  ...
  static Future<double> benchmarkFunction(
