...
//
//     final carwashInProgressModal = carwashInProgressModalFromJson(jsonString);

import 'dart:convert';

CarwashInProgressModal carwashInProgressModalFromJson(String str) =>
    CarwashInProgressModal.fromJson(json.decode(str));

String carwashInProgressModalToJson(CarwashInProgressModal data) =>
    json.encode(data.toJson());

class CarwashInProgressModal {
  Message message;

  CarwashInProgressModal({required this.message});

  factory CarwashInProgressModal.fromJson(Map<String, dynamic> json) =>
      CarwashInProgressModal(message: Message.fromJson(json["message"]));
