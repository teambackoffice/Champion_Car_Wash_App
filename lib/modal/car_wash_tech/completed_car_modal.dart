...
//
//     final carwashCompletedModal = carwashCompletedModalFromJson(jsonString);

import 'dart:convert';

CarwashCompletedModal carwashCompletedModalFromJson(String str) =>
    CarwashCompletedModal.fromJson(json.decode(str));

String carwashCompletedModalToJson(CarwashCompletedModal data) =>
    json.encode(data.toJson());

class CarwashCompletedModal {
  Message message;

  CarwashCompletedModal({required this.message});

  factory CarwashCompletedModal.fromJson(Map<String, dynamic> json) =>
      CarwashCompletedModal(message: Message.fromJson(json['message']));
