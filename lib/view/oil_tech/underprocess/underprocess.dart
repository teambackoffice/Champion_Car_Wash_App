...
class _InspectionDialogState extends State<InspectionDialog> {
  List<InspectionItem> inspectionItems = [
    ...
    InspectionItem(title: "Coolant Level"),
    InspectionItem(title: "Exhaust System"),
    InspectionItem(title: "Suspension Check"),
  ...
  void _completeInspection(BuildContext context) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Service completed for ${widget.booking.bookingId}'),
        backgroundColor: Colors.green,
        duration: const Duration(seconds: 2),
      ),
    );
    // Add your service completion logic here
  }
}
