  ...
  group('PerformanceTestSuite Unit Tests', () {
    group('calculatePerformanceScore', () {
      ...
      test('should assign correct grades based on score', () async {
        ...
        final excellentScore = await PerformanceTestSuite.calculatePerformanceScore(excellentResults);
        ...
        final failingScore = await PerformanceTestSuite.calculatePerformanceScore(failingResults);
      ...
      test('should handle performance ratio calculations correctly', () async {
        ...
        final betterScore = await PerformanceTestSuite.calculatePerformanceScore(betterResults);
        ...
        final worseScore = await PerformanceTestSuite.calculatePerformanceScore(worseResults);
    ...
    group('Error Handling', () {
      test('runStartupTests should handle errors gracefully', () async {
        ...
        final result = await PerformanceTestSuite.runStartupTests(
          timeout: const Duration(milliseconds: 1), // Very short timeout to force error
        );
