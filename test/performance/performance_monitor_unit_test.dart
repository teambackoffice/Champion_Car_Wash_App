...
void main() {
  ...
  group('AlertLevel Tests', () {
    test('should have correct descriptions', () {
      expect(AlertLevel.RED.description, equals('Critical - Immediate action required'));
      expect(AlertLevel.YELLOW.description, equals('Warning - Monitor closely'));
      expect(AlertLevel.GREEN.description, equals('Good - Performance is optimal'));
    });
  });
