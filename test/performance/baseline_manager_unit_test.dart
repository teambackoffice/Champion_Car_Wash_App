...
void main() {
  group('BaselineManager Tests', () {
    ...
    group('History Management', () {
      test('should record metrics to history', () async {
        ...
        expect(
          history.first.metrics.startupTimeMs,
          equals(metrics.startupTimeMs),
        );
      });
      ...
      test('should limit history entries', () async {
        ...
        for (int i = 0; i < 5; i++) {
          await manager.recordToHistory(
            _createTestMetrics(startupTime: i * 100),
          );
        }
    ...
    group('Metrics Comparison', () {
      ...
      test(
        'should return no baseline comparison when baseline missing',
        () async {
          final currentMetrics = _createTestMetrics();
    ...
    group('Performance Trends', () {
      ...
      test('should calculate trends for specific time period', () async {
        ...
        for (int i = 0; i < 3; i++) {
          await manager.recordToHistory(
            _createTestMetrics(startupTime: 2000 - (i * 200)),
          );
  ...
  group('MetricsComparison Tests', () {
    test('should calculate startup time improvement correctly', () {
      ...
      expect(
        comparison.startupTimeImprovement,
        equals(25.0),
      ); // 25% improvement
    });
    ...
    test('should calculate memory usage improvement correctly', () {
      ...
      expect(
        comparison.memoryUsageImprovement,
        closeTo(16.67, 0.01),
      ); // ~16.67% improvement
    });
