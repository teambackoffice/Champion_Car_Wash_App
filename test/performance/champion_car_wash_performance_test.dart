  ...
  group('Champion Car Wash Performance Testing Framework', () {
    ...
    group('PerformanceTestSuite', () {
      test('should run startup performance tests successfully', () async {
        ...
        expect(result.testName, equals('Champion Car Wash Startup Performance'));
        ...
        expect(result.additionalMetrics.containsKey('statefulWidgetCount'), isTrue);
        expect(result.additionalMetrics.containsKey('firstMeaningfulPaint'), isTrue);
      });
      ...
      test('should run UI performance tests successfully', () async {
        ...
        expect(result.actualValue, greaterThan(0));
        expect(result.additionalMetrics, isNotEmpty);
        expect(result.additionalMetrics.containsKey('bookingItemCount'), isTrue);
        expect(result.additionalMetrics.containsKey('scrollPerformance'), isTrue);
      });
      ...
      test('should run API performance tests successfully', () async {
        ...
        expect(result, isA<TestResults>());
        expect(result.testName, equals('Champion Car Wash Payment Performance'));
        expect(result.unit, equals('ms'));
        expect(result.targetValue, equals(5000.0));
        expect(result.actualValue, greaterThan(0));
        expect(result.additionalMetrics, isNotEmpty);
        expect(result.additionalMetrics.containsKey('stripeInitialization'), isTrue);
        expect(result.additionalMetrics.containsKey('paymentProcessing'), isTrue);
      });
      ...
      test('should run memory stability tests successfully', () async {
        ...
        expect(result.actualValue, greaterThan(0));
        expect(result.additionalMetrics, isNotEmpty);
        expect(result.additionalMetrics.containsKey('memoryLeaksDetected'), isTrue);
      ...
      test('should calculate performance score correctly', () async {
        ...
        final score = await PerformanceTestSuite.calculatePerformanceScore(testResults);
    ...
    group('StartupPerformanceTest', () {
      test('should execute startup test with detailed metrics', () async {
        ...
        expect(result.additionalMetrics.containsKey('frameworkInitTime'), isTrue);
        expect(result.additionalMetrics.containsKey('widgetTreeTime'), isTrue);
        expect(result.additionalMetrics.containsKey('firstMeaningfulPaint'), isTrue);
        expect(result.additionalMetrics.containsKey('statefulWidgetCount'), isTrue);
        
        final widgetCount = result.additionalMetrics['statefulWidgetCount'] as int;
    ...
    group('BookingListPerformanceTest', () {
      test('should execute booking list test with scrolling metrics', () async {
        ...
        expect(result.additionalMetrics.containsKey('bookingItemCount'), isTrue);
        expect(result.additionalMetrics.containsKey('scrollPerformance'), isTrue);
        expect(result.additionalMetrics.containsKey('searchPerformance'), isTrue);
    ...
    group('PaymentPerformanceTest', () {
      test('should execute payment test with Stripe NFC metrics', () async {
        ...
        expect(result.unit, equals('ms'));
        expect(result.additionalMetrics.containsKey('stripeInitialization'), isTrue);
        expect(result.additionalMetrics.containsKey('nfcResponsiveness'), isTrue);
        expect(result.additionalMetrics.containsKey('paymentProcessing'), isTrue);
    ...
    group('MemoryStabilityTest', () {
      test('should execute memory test with leak detection', () async {
        ...
        expect(result.unit, equals('MB'));
        expect(result.additionalMetrics.containsKey('memoryLeaksDetected'), isTrue);
        expect(result.additionalMetrics.containsKey('widgetDisposalChecks'), isTrue);
        expect(result.additionalMetrics.containsKey('cycleCount'), isTrue);
    ...
    group('TestResults Model', () {
      test('should calculate improvement percentage correctly for time-based metrics', () {
      ...
      test('should calculate improvement percentage correctly for rate-based metrics', () {
        final result = TestResults(
        ...
        expect(result.improvementPercentage, closeTo(8.33, 0.1)); // ~8.33% improvement
        expect(result.showsImprovement, isTrue);
      });
    ...
    group('Performance Score Calculation', () {
      test('should assign correct grades based on score', () async {
        ...
        final score = await PerformanceTestSuite.calculatePerformanceScore(perfectResults);
      ...
      test('should handle failed tests in score calculation', () async {
        ...
        final score = await PerformanceTestSuite.calculatePerformanceScore(failedResults);
        expect(score.grade, equals('F'));
        expect(score.score, equals(0.0));
      });
    });
