...
void main() {
  group('TestResults Unit Tests', () {
    ...
    group('Improvement Percentage Calculation', () {
      test('should calculate improvement for time-based metrics (lower is better)', () {
      ...
      test('should calculate improvement for fps metrics (higher is better)', () {
    ...
    group('JSON Serialization', () {
      ...
      test('should deserialize from JSON correctly', () {
        ...
        expect(result.targetValue, equals(2000.0));
        expect(result.unit, equals('ms'));
        expect(result.timestamp, equals(DateTime.parse('2023-10-15T10:30:00.000Z')));
        expect(result.additionalMetrics, equals({'executionTimeMs': 150, 'iterations': 100}));
      });
    });
