  ...
  group('Booking List Performance Test Validation', () {
    ...
    test('Search performance validation with debouncing', () async {
      ...
      final averageResponseTime =
          searchMetrics['averageResponseTime'] as double;
      ...
      expect(
        ...
        reason:
            'Search response time should be reasonable including debouncing',
      );
    ...
    test('Scrolling performance validation with 60fps target', () async {
      final result = await bookingListTest.execute();
      final scrollMetrics =
          result.additionalMetrics['scrollPerformance'] as Map<String, dynamic>;
      ...
      final scenarios =
          scrollMetrics['scenarioResults'] as Map<String, dynamic>;
